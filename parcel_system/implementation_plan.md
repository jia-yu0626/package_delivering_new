...
=======
- [j]  初始化專案結構與環境設定 (`requirements.txt`)
>>>>>>> 52dd12edf9857ffc36ca5ae32e6fc4ba045bde88
...
=======
- [ ] 註冊按鈕大小需調整，包裹服務類型沒有顯示
- [j] 實作主要頁面 (首頁, 追蹤頁, 登入頁, 後台管理)
>>>>>>> 52dd12edf9857ffc36ca5ae32e6fc4ba045bde88
- [ ] 撰寫測試案例 (`tests/test_core.py`)
- [x] 司機的編輯屬性需刪除
- [j] 客服人員的編輯屬性需刪除，運送進度取消
- [h] 系統管理員修改計費規則，其他功能全部刪除，從資料庫查看所有帳號密碼
- [j] 客戶我的帳單勾選框，計算總額
- [ ] 判斷運送進度邏輯
- [ ] 合約客戶立即寄件壞掉
